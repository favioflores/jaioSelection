...
/**
 * DAO object for domain model class Elemento.
 * @see jaio.selection.orm.Elemento
...
public class ElementoDAO {
    ...
    public Elemento merge(Elemento detachedInstance) {
        ...
        try {
            Elemento result = (Elemento) sessionFactory.getCurrentSession()
    ...
    public Elemento findById( java.lang.Integer id) {
        log.debug("getting Elemento instance with id: " + id);
        try {
            Elemento instance = (Elemento) sessionFactory.getCurrentSession()
                    .get("jaio.selection.orm.Elemento", id);
            if (instance==null) {
    ...
    public List findByExample(Elemento instance) {
        log.debug("finding Elemento instance by example");
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("jaio.selection.orm.Elemento")
