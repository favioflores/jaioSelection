...
public class Empresa implements java.io.Serializable {
    ...
    public Empresa(Usuario usuario, String nombre, Date fechaRegistro, int estado, Integer orden, byte[] imagen, String tipo_imagen, Set areas, Set areas_1, Set perfils, Set perfils_1) {
        this.usuario = usuario;
        this.nombre = nombre;
        this.fechaRegistro = fechaRegistro;
        this.estado = estado;
